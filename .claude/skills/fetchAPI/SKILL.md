---
name: fetchAPI
description: Fetches data from an API endpoint and handles the response data. Use when you want to fetch data from an external API endpoint, such as a weather API, or when the user asks for data from an API.
---
